    ...
    try:
        async for message in websocket:
            ...
            for cliente in clientes:
                if cliente != websocket:  # Evita eco para o próprio remetente
...
async def main():
    async with websockets.serve(chat, "localhost", 2222):
        print("Servidor WebSocket iniciado em ws://localhost:2222")
